# Generated by Django 4.1.4 on 2023-01-04 23:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mtn', models.CharField(default=apps.trak.models.manifest.draft_mtn, max_length=15, verbose_name='manifest Tracking Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trak.manifest')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254)),
                ('epa_sites', models.ManyToManyField(blank=True, related_name='sites', to='trak.site')),
