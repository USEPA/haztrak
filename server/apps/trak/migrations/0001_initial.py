...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emergency_phone', models.ForeignKey(blank=True, help_text='Emergency phone number for the hazardous waste rcra_site', null=True, on_delete=django.db.models.deletion.PROTECT, to='trak.manifestphone')),
                ('paper_signature', models.OneToOneField(blank=True, help_text='The signature associated with hazardous waste custody exchange', null=True, on_delete=django.db.models.deletion.CASCADE, to='trak.papersignature')),
                ('rcra_site', models.ForeignKey(help_text='Hazardous waste rcra_site associated with the manifest', on_delete=django.db.models.deletion.CASCADE, to='site.rcrasite')),
            ],
            options={
                'ordering': ['rcra_site'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transporters', to='manifest.manifest')),
            ],
            options={
