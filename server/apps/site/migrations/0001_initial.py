    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='site.haztrakorg')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='site.contact', verbose_name='contact information')),
                ('emergency_phone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='site.rcraphone')),
                ('mail_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mail_address', to='site.address')),
                ('site_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='site_address', to='site.address')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='permissions', to='core.rcrainfoprofile')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='site.rcrasite')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='rcra_site',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='site.rcrasite', verbose_name='rcra_site'),
        ),
        migrations.AddField(
            model_name='contact',
            name='phone',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='site.rcraphone'),
        ),
    ]
